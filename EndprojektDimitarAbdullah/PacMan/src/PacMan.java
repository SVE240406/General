...
public class PacMan extends JPanel implements ActionListener, KeyListener {
    ...
    public void draw(Graphics g) {
        ...
        if(gameOver){
            ...
            g.drawString("                              Press any Key to restart the Game!", tileSize/2, tileSize/2);
        }
        else {
    ...
    public void move(){
        ...
        if(pacman.y == tileSize*9 && pacman.x == 0) {
            pacman.x = tileSize*18;
        }
        else if(pacman.y == tileSize*9 && pacman.x == tileSize*18) {
            pacman.x = 0;
        }


        //Zusammenstoß Pacman & Geister
        for(Block ghost : ghosts) {
            ...
            else if(ghost.y == tileSize*9 && ghost.x == tileSize*18) {
                ghost.x = 0;
            }
